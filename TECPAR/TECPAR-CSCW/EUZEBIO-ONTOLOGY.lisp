;;;===============================================================================
;;;10/12/06
;;;             AGENT EUZEBIO: ONTOLOGY (file EUZEBIO-ontology.lisp)
...
However, EUZEBIO is not a specialist of those subjects and its ontology is rather
shallow. It contains enough vocabulary to ask a specialist (one of the staff agent).

Questions asked to EUZEBIO:
...
2009
 0720 adding the description of people/pa combinations in the EUZEBIO package   
|#

(in-package :EUZEBIO)

(defontology 
  (:title "EUZEBIO ontology")
  (:version "1.0")
  (:language :br)
  )
...
;;; EUZEBIO has been defined as an omas-agent when created
;;; ALBERT and ALFREDO have also been defined as OMAS agents but are not in EUZEBIO 
;;; environment
